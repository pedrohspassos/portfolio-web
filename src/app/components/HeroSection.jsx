  ...
  return (
    <section className="lg:py-16" >
      <div className="grid grid-cols-1 lg:grid-cols-12 my-4">
        <div className="col-span-7 place-self-center place-items-center grid lg:place-items-start sm:text-left justify-self-start ">
          ...
          <p className="text-[#ADB7BE] mb-6 textl-lg lg:text-xl">
            ...
            centralize informations about my experiences in software development.
          </p>
          <div>
