      ...
      >
        ...
        <div className="z-10">
          ...
          <div className="socials flex flex-row gap-2">
            <Link href="https://github.com/pedrohspassos" target="_blank">
              <Image src={GithubIcon} alt="Github Icon" />
            </Link>

            <Link href="https://www.linkedin.com/in/pedrohspassos/" target="_blank">
        ...
        <div>
          <form className="flex flex-col">
            ...
            <button
              type="submit"
              className="bg-primary-800 hover:bg-primary-900 text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
              Send Message
            </button>
          </form>
